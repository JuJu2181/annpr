...
def detect_np_from_video(YOLO_Detection,YOLO_Seperation,video_path):
...
def main_annpr_detector(detector,filename):
    ...
    if detector == 'image': 
        ...
        output_numbers = detect_np_from_video(YOLO_detection, YOLO_seperation, filename)
    else:
